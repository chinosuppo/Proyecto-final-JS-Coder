$(document).ready(function(){
    ...
    articulos.forEach((item, index) => {
        ...
        /*
        <article class="post">
            <h2>Descubrimiento ovinovoro</h2>
                <span class="fecha">Fecha publicacion del articulo</span>
                    <p>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                        Modi laudantium sed, tempora est cumque dignissimos
                        molestiae placeat porro incidunt fugit? Cum, explicabo
                        neque! Expedita inventore reiciendis iusto, accusamus
                        velit id.
                    </p>
            <a href="#" class="boton-leer">Leer más</a>
        </article>
